minerals_info = [
    {
        "name": "Fosfor",
        "info": "Fosfor samverkar med kalcium vid bildning och stärkning av ben och tänder. Det är även viktigt för syra-bas balansen i kroppen och för energiproduktion till kroppens alla energikrävande funktioner. Fosfor är ett livsnödvändigt, essentiellt grundämne. Den största mängden finns lagrad i skelettet.",
    ...
    },
    {
        ...
        "info1": "Vi får i oss jod från livsmedel såsom fisk, skaldjur, ägg och mejeriprodukter. Även joderat koksalt är en viktig källa till jod. Vissa algprodukter som säljs som näringstillskott innehåller mycket jod, dock kan det skilja mycket beroende på preparat vilket troligen beror på att de utgår från olika algarter.",
